...
require_binaries
IFS='|' read -r dir tcp_port _udp_port _multicast inventory server_config client_config uds count < <(make_single_fixture "client-first-static" 11)
...
assert_server_disconnect_seen "$dir/server.log" "tcp"
