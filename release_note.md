...
For most deployments, install the server package on GPU nodes and the client package on user-facing nodes. Use UDP when the network allows it; switch the client config to TCP if the network blocks UDP.
